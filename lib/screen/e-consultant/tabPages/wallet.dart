...
class EconsultantWalletScreen extends StatefulWidget {
  const EconsultantWalletScreen({Key? key}) : super(key: key);

  @override
  _EconsultantWalletScreenState createState() => _EconsultantWalletScreenState();
}

class _EconsultantWalletScreenState extends State<EconsultantWalletScreen> {
  @override
