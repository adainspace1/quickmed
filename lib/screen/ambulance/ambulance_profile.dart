...
class _AmbulanceProfileScreenState extends State<AmbulanceProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<AmbulanceProfileProvider>(
        builder: (context, ambulanceProfileProvider, child) {
          if (ambulanceProfileProvider.user != null) {
            return FutureBuilder<DriverModel?>(
              future: ambulanceProfileProvider.getUserByUid(),
