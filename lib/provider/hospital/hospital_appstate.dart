...
class HospitalAppProvider extends ChangeNotifier {
  ...
  HospitalServices _hospitalServices = HospitalServices();
  HospitalServices get hosptalservice => _hospitalServices;

  BitmapDescriptor? _carPin;
  BitmapDescriptor? get carpin => _carPin;

    HospitalModel? _user;
  HospitalModel? get getUser => _user;
  // //   location pin
  ...
  Future<Position> _getUserLocation() async {
    ...
    _hospitalServices.updateLocation(
  ...
  Future<void> refreshUser() async {
    HospitalModel user = await _hospitalServices.getUserByUid();
    _user = user;
    notifyListeners();
  }
